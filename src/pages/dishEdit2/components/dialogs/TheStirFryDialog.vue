...
import GearSlider from "pages/dishEdit2/components/select/GearSlider.vue";
import DurationSelect from "pages/dishEdit2/components/select/DurationSelect.vue";
