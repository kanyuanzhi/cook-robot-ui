...
import TheNetworkConnection from "pages/systemSettings/panels/TheNetworkConnection.vue";
import ThePhonePairing from "pages/systemSettings/panels/ThePhonePairing.vue";
