      ...
      <q-card style="min-width: 350px">
        ...
        <q-card-section class="q-py-none">
          <q-input
            ...
            label="网络名称"
            autofocus
            @keyup.enter="onConnectionBtnClick"
            @focus="onInputFocus(e, 'ssid')"
...
function onConnectionBtnClick() {
  connectWifi(1, { bssid: ssid.value, password: password.value }).then(
    (res) => {
